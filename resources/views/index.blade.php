          ...
          <form id="search-form" name="gs" method="submit" role="search" action="/search">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                  <fieldset>
                      <input type="address" name="query" class="searchText" placeholder="Enter product name" autocomplete="on" required>
                  </fieldset>
              </div>
              {{-- <div class="col-lg-3 align-self-center">
                  <fieldset>
              ...
              <div class="col-lg-3">                        
                  <fieldset>
                      <button class="main-button"><i class="fa fa-search" type="submit"></i> Search Now</button>
                  </fieldset>
              </div>
            </div>
          </form>
